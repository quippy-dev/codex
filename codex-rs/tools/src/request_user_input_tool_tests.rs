...
fn default_mode_enabled_available_modes() -> Vec<ModeKind> {
    ...
    features.enable(Feature::RequestUserInputOutsidePlanMode);
...
fn request_user_input_tool_description_mentions_available_modes() {
    ...
    assert_eq!(
        ...
        "Request user input for one to three short questions and wait for the response. This tool is only available in modes: Plan,Default,Execute,Pair Programming.".to_string()
    );
}
