...
impl ChatWidget {
    ...
    fn dispatch_event_msg(&mut self, id: Option<String>, msg: EventMsg, from_replay: bool) {
        ...
        match msg {
            ...
            EventMsg::CollabCloseEnd(ev) => self.add_to_history(crate::collab::close_end(ev)),
            EventMsg::CollabResumeBegin(ev) => self.add_to_history(crate::collab::resume_begin(ev)),
            EventMsg::CollabResumeEnd(ev) => self.add_to_history(crate::collab::resume_end(ev)),
