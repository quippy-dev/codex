...
pub(super) struct ThreadEventStore {
    ...
    pub(super) pending_interactive_replay: PendingAppServerRequests,
...
impl ThreadEventStore {
    ...
    pub(super) fn new(capacity: usize) -> Self {
        Self {
            ...
            turns: Vec::new(),
            buffer: VecDeque::new(),
            pending_interactive_replay: PendingAppServerRequests::default(),
            active_turn_id: None,
            input_state: None,
            capacity,
            active: false,
    ...
    pub(super) fn apply_thread_rollback(&mut self, response: &ThreadRollbackResponse) {
        ...
        self.buffer.clear();
        self.pending_interactive_replay = PendingAppServerRequests::default();
        self.active_turn_id = None;
    }
    ...
    where
        T: Into<AppCommand>,
    {
        PendingAppServerRequests::op_can_change_state(op)
    }
