...
pub use super::auth_file_contract::resolve_auth_storage_home;
pub use super::auth_file_contract::validate_auth_file_override;
pub use super::auth_file_ops::load_auth_dot_json_with_auth_file;
pub use super::auth_file_ops::logout_with_auth_file;
pub use super::auth_file_ops::save_auth_with_auth_file;
pub use super::auth_file_runtime::AuthFileRuntime;
use super::auth_file_runtime::load_auth_with_auth_file;
use super::auth_file_runtime::logout_all_stores_with_auth_file;
...
impl CodexAuth {
    ...
    pub async fn from_auth_storage(
        ...
        Self::from_auth_storage_with_auth_file(
            codex_home,
    ...
    pub async fn from_auth_storage_with_auth_file(
        codex_home: &Path,
        auth_credentials_store_mode: AuthCredentialsStoreMode,
        auth_file: Option<PathBuf>,
        chatgpt_base_url: Option<&str>,
    ...
    pub(super) fn from_api_key_with_client(api_key: &str, _client: CodexHttpClient) -> Self {
...
impl AuthManager {
    ...
    pub async fn new_with_auth_file(
        codex_home: PathBuf,
        enable_codex_api_key_env: bool,
        auth_credentials_store_mode: AuthCredentialsStoreMode,
        auth_file: Option<PathBuf>,
    ...
    async fn new_with_auth_file_and_base_url(
        codex_home: PathBuf,
        enable_codex_api_key_env: bool,
        auth_credentials_store_mode: AuthCredentialsStoreMode,
        auth_file: Option<PathBuf>,
    ...
    pub async fn shared_from_config_with_auth_file(
        config: &impl AuthManagerConfig,
        enable_codex_api_key_env: bool,
        auth_file: Option<PathBuf>,
    ...
    pub async fn shared_from_config_with_auth_file_and_base_url(
        config: &impl AuthManagerConfig,
        enable_codex_api_key_env: bool,
        auth_file: Option<PathBuf>,
        chatgpt_base_url: Option<String>,
    ...
    pub async fn shared_with_auth_file(
        codex_home: PathBuf,
        enable_codex_api_key_env: bool,
        auth_credentials_store_mode: AuthCredentialsStoreMode,
        auth_file: Option<PathBuf>,
    ...
    pub fn auth_file_override(&self) -> Option<&Path> {
        self.auth_file.as_deref()
    }

    pub fn enable_codex_api_key_env(&self) -> bool {
        self.enable_codex_api_key_env
    }
    ...
    /// Return the resolved auth storage home used by this manager.
    ///
    /// When `--auth-file` is active this is the parent directory of that
    /// `auth.json`, not the process-wide Codex home.
