...
impl ToolHandler for Handler {
    ...
    async fn handle(&self, invocation: ToolInvocation) -> Result<Self::Output, FunctionCallError> {
        ...
        let receiver_agent = session
            ...
            .unwrap_or_default();
        let receiver_spawn_mode = session
            .services
            .agent_control
                ...
                session
                    .send_event(
                        ...
                        CollabCloseEndEvent {
                            ...
                            receiver_spawn_mode,
                            close_result: CollabCloseResult::NotFound,
                            status,
                        }
                        .into(),
                    )
        ...
        let close_result = if is_final(&status) {
            CollabCloseResult::AlreadyClosed
        } else {
            CollabCloseResult::Closed
        };
