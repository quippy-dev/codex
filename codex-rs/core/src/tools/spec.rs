...
pub(crate) fn build_specs_with_discoverable_tools(
    ...
    use crate::tools::handlers::multi_agents::ListAgentsHandler as ListAgentsHandlerV1;
    use crate::tools::handlers::multi_agents::PeekAgentsHandler;
    ...
    for handler in plan.handlers {
        match handler.kind {
            ...
            ToolHandlerKind::CompactParentContextV1 => {
            ...
            ToolHandlerKind::ListAgentsV1 => {
                builder.register_handler(handler.name, Arc::new(ListAgentsHandlerV1));
            }
            ...
            ToolHandlerKind::PeekAgentsV1 => {
                builder.register_handler(handler.name, Arc::new(PeekAgentsHandler));
            }
