...
#[test]
fn tools_web_search_true_is_rejected() {
...
"#,
    ...
    .expect_err("legacy boolean config should be rejected");
    assert!(err.to_string().contains("WebSearchToolConfig"));
}

#[test]
fn tools_web_search_false_is_rejected() {
    let err = toml::from_str::<ConfigToml>(
        r#"
[tools]
web_search = false
