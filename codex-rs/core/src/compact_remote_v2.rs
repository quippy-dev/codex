...
use crate::compact_remote::estimate_tool_token_count;
use crate::compact_remote::log_remote_compact_failure;
use crate::compact_remote::process_compacted_history;
use crate::compact_remote::trim_history_to_fit_context_window_for_remote_compaction;
...
async fn run_remote_compact_task_inner_impl(
    ...
    let prompt_input_for_tools = history
        .clone()
        .for_prompt(&turn_context.model_info.input_modalities);
    let tool_router = built_tools(
        sess.as_ref(),
        turn_context.as_ref(),
        &prompt_input_for_tools,
        &HashSet::new(),
        /*skills_outcome*/ None,
        &CancellationToken::new(),
    )
    .await?;
    let compact_tools = tool_router.model_visible_specs();
